...
<!-- =========================================================================================================================================================================================================================================== -->
						...
						<li class="nav-item">
					        ...
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="AdminUserList.php?CurrentPageIndex=1&fUserListSearchHolder=&fRequestSearchOnUserList=true">
						        <span class="nav-icon">
...
<!-- =========================================================================================================================================================================================================================================== -->
						...
						<li class="nav-item">
					        ...
					        <a class="nav-link active" href="AdminCategotyList.php?CurrentPageIndex=1">
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row px-3 py-3 g-2 justify-content-start justify-content-md-end align-items-center">
							    ...
							    <div class="col-auto">
								    <form class="table-search-form row gx-1 align-items-center" action="AdminCategotyList.php" method="get">
					                    <div class="col-auto">
					                        <input type="text" id="search-orders" name="fCategoryListSearchHolder" class="form-control search-orders" placeholder="Search">
					                    </div>
					                    <div class="col-auto">
					                        <button name="fRequestSearchOnCategoryList" value="true" type="submit" class="btn app-btn-secondary">Search</button>
					                    </div>
					                </form>
